...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_mal__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_anilist__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mediator__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_string_to_html__ = __webpack_require__(122);
...
var services = {
  toHtml: __WEBPACK_IMPORTED_MODULE_5_string_to_html__["a" /* default */],
  providers: {
    mal: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__providers_mal__["a" /* default */])(),
    aniList: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__providers_anilist__["a" /* default */])(localStorage)
  },
  storage: localStorage,
  bus: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__mediator__["a" /* default */])(),
  date: __WEBPACK_IMPORTED_MODULE_4_moment___default.a
};
...
function card(_ref, refElement, anime) {
  ...
  var formatCountdown = function formatCountdown() {
    if (!anime.airing) return;

    var airDate = anime.airing.time;
    var airs = date(airDate);
    var today = date();
    ...
    var dayOfTheWeek = airs.format("dddd");

    return 'Airs ' + dayOfTheWeek + 's (' + airs.from(today, true) + ' left)';
  };

  var airedToday = function airedToday() {};
  ...
  var incrementEpisode = function incrementEpisode() {
    ...
    if (state.currentEpisode === anime.episodeCount - 1) elements.episodeCount.classList.add('completed');
  ...
  var updateCard = function updateCard() {
    ...
    if (state.airing) {
      ...
      if (state.airing.next_episode) {
        if (state.airing.next_episode - 1 !== anime.currentEpisode) elements.episodeCount.classList.add('next-episode');
  ...
  var showCompleteButton = function showCompleteButton() {};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_card__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_cardContainer__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_loader__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_login__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_toast__ = __webpack_require__(115);
...
function core(services) {
  ...
  var loginComponent = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__components_login__["a" /* default */])(services, provider, '[data-ref="login"]');
  ...
  loginComponent.loginOrPrompt().then(function (user) {
    ...
    var toast = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__components_toast__["a" /* default */])(services, '[data-ref="toast"]');
    var appLoadIcon = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__components_loader__["a" /* default */])(services, '[data-ref="loader"]');
    var container = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__components_cardContainer__["a" /* default */])(services, __WEBPACK_IMPORTED_MODULE_1__components_card__["a" /* default */], '[data-ref="cardContainer"]', list);
...
function anilist(storage) {
  ...
  var clientSecret = 'X9X9Hok53RIFmFT0iuXHa9GlE08eq';

  var base = 'https://anilist.co/api/';
  var token = null;

  var constructUriParams = function constructUriParams(params) {
  ...
  var fetchClientCredentialsToken = function fetchClientCredentialsToken() {
    var authEndpoint = 'auth/access_token';
    ...
    var queryParams = constructUriParams(params);

    return fetch(base + authEndpoint + '?' + queryParams, { method: "POST" }).then(function (response) {
  ...
  var cacheToken = function cacheToken(token) {
    storage.setItem('app.aniToken', JSON.stringify(token));
  };

  var getToken = function getToken() {
    if (!token) {
      var cachedToken = storage.getItem('app.aniToken');
  ...
  var getClientCredentialsToken = function getClientCredentialsToken() {
    token = getToken();
  ...
  var getAiringDatesByTitles = function getAiringDatesByTitles(titles) {
    return getClientCredentialsToken().then(function (token) {
      ...
      var date = new Date();
      var queryParams = constructUriParams({
  ...
  return {
    getAiringDatesByTitles: getAiringDatesByTitles
  };
}
...
/* harmony default export */ __webpack_exports__["a"] = MALjs;
;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mal_api__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shell__ = __webpack_require__(109);
